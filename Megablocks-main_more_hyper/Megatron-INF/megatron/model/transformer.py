...
from megatron.core.parallel_state import get_tensor_and_expert_parallel_group, get_data_parallel_group
...
class _MegablocksAdapter(MegatronModule):
    ...
    def __init__(self, layer_cls, init_method, output_layer_init_method):
        ...
        if args.moe_expert_model_parallelism:
            args.expert_parallel_group = get_data_parallel_group()
            ...
            if args.moe_num_experts is not None:
                if args.moe_use_megatron_switch:
                    ...
                    if args.add_moe_share_expert == True:
                        self.mlp_share = ParallelMLP(config, share_expert_ffn_hidden_size = args.moe_share_expert_ffn_hidden_size)
                else:
