...
class Arguments:
    ...
    num_layers : int = 1 #number of all layers
    moe_num_layers : int = 1 #number of layers that use moe
    bias : bool = False
    ...
    # add swiglu on original network
    swiglu : bool = True
...
def from_megatron(megatron_args):
    ...
    #additional args mapping
    args.bias = megatron_args.add_moe_bias
    if megatron_args.moe_expert_ffn_hidden_size != None:
        args.ffn_hidden_size = megatron_args.moe_expert_ffn_hidden_size
    return args
